...
defineSupportCode(function ({ GIVEN, WHEN, THEN }) {
    ...
    GIVEN(/^I see "Carlos Magno", "Helena Torres", "João Paulo", "Maria Eugênia" in the students list$/, async() => {
        
    })
    WHEN(/^I remove the student with the name "Helena Torres"$/, async() => {
        
    })
    THEN(/^I can see "Carlos Magno", "João Paulo", "Maria Eugênia" in the students list$/, async() => {
